...
public class Java8CommonProgrammingQA {
    ...
    public static void main(String[] args) {
        ...
        List<Student> studentsRankedBetween50And100 = studentList.stream()
                .filter(student -> student.getRank() > 50 && student.getRank() < 100)
                .toList();

        studentsRankedBetween50And100.forEach(System.out::println);
        System.out.println("###############################\n");

        // 2. Find the Students who stays in Karnataka and sort them by their names in reverse order
        System.out.println("2. Find the Students who stays in Karnataka and sort them by their names in reverse order");

        List<Student> studentsLocatedInKarnatakaSortedByNames = studentList.stream()
                .filter(student -> student.getCity().equals("Karnataka"))
                .sorted(Comparator.comparing(Student::getFirstName, Comparator.reverseOrder()))
                .toList();

        studentsLocatedInKarnatakaSortedByNames.forEach(System.out::println);
        System.out.println("###############################\n");
        ...
        studentsByDepartment.forEach((department, students) -> {
            System.out.println("-------------------------------");
        ...
        // 6. Find the department who is having the highest number of students
        System.out.println("6. Find the department who is having the highest number of students");
        ...
        System.out.println(highestRankByDept);
        System.out.println("###############################\n");
